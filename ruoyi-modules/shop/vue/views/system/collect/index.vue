<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="文章编号" prop="cid">
        <el-input
      ...
      <el-form-item label="记录类型(1收藏,2点赞)" prop="type">
        <el-select v-model="queryParams.type" placeholder="请选择记录类型(1收藏,2点赞)" clearable size="small">
    ...
    <el-table v-loading="loading" :data="collectList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="文章编号" align="center" prop="cid" />
      <el-table-column label="会员MID" align="center" prop="mid" />
      <el-table-column label="记录类型(1收藏,2点赞)" align="center" prop="type" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="文章编号" prop="cid">
          <el-input v-model="form.cid" placeholder="请输入文章编号" />
        </el-form-item>
        <el-form-item label="会员MID" prop="mid">
          <el-input v-model="form.mid" placeholder="请输入会员MID" />
        </el-form-item>
        <el-form-item label="记录类型(1收藏,2点赞)" prop="type">
          <el-select v-model="form.type" placeholder="请选择记录类型(1收藏,2点赞)">
            <el-option label="请选择字典生成" value="" />
          </el-select>
        </el-form-item>
        <el-form-item label="创建时间" prop="createAt">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除数据-文章-会员-收藏编号为"' + ids + '"的数据项?', "警告", {
