<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="权限状态(1使用,0禁用)" prop="status">
        <el-select v-model="queryParams.status" placeholder="请选择权限状态(1使用,0禁用)" clearable size="small">
    ...
    <el-table v-loading="loading" :data="markList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="权限状态(1使用,0禁用)" align="center" prop="status" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="权限状态(1使用,0禁用)">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除数据-文章-标签编号为"' + ids + '"的数据项?', "警告", {
