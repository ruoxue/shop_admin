<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="排序权限" prop="sort">
        <el-input
    ...
    <el-table v-loading="loading" :data="provinceList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="排序权限" align="center" prop="sort" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="排序权限" prop="sort">
          <el-input v-model="form.sort" placeholder="请输入排序权限" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除商城-快递-省份编号为"' + ids + '"的数据项?', "警告", {
